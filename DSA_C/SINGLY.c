...
/*Author:Dr. Anand Kr. Pandey,
	 Asstt. Professor, T. N. B. College,Bhagalpur
...
void operation(int choice)
{
	...
	switch(choice)
	{
		...
		case 3:
			...
			temp=create(ele);
			insert_at_beg(temp);
			printf("\nThe element %d has been inserted successfully at the beginning of the list.\n",ele);
			break;
		case 4:
		...
		case 5:
			display();
			printf("\nEnter the to element which you want to insert:");
			scanf("%d",&ele);
